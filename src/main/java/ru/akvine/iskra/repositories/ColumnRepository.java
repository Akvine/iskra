...
public interface ColumnRepository extends JpaRepository<ColumnEntity, Long> {
    ...
    @Query("from ColumnEntity ce " + "where ce.table.name = :tableName " + "and " + "ce.uuid in :uuids")
    List<ColumnEntity> findAll(@Param("tableName") String tableName, @Param("uuids") Collection<String> uuids);
