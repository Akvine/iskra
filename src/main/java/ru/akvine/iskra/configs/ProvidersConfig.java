...
public class ProvidersConfig {
    ...
    public NotificationServicesProvider notificationServicesProvider(
        ...
        Map<NotificationServiceType, NotificationService<? extends NotificationPayload>> servicesMap =
                services.stream().collect(toMap(NotificationService::getType, identity()));
    ...
    public StateHandlersProvider stateHandlersProvider(List<PlanStateHandler> planStateHandlers) {
        Map<PlanState, PlanStateHandler> handlers =
                planStateHandlers.stream().collect(toMap(PlanStateHandler::getCurrentState, identity()));
