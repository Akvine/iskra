...
public class ColumnConfigurationDictionaryServiceImpl implements ColumnConfigurationDictionaryService {
    ...
    @Override
    public List<ColumnConfigurationDictionaryModel> create(ColumnConfigurationEntity columnConfiguration, List<DictionaryEntity> dictionaries) {
        ...
        for (DictionaryEntity dictionary : dictionaries) {
            ColumnConfigurationDictionaryEntity columnConfigurationDictionaryToCreate = new ColumnConfigurationDictionaryEntity()
